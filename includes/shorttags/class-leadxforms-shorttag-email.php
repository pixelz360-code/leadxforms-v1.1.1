...
class LeadXForms_ShortCode_Email extends LeadXForms_ShortCode_Tag {
    ...
    public function output() {
        ...
        $output = '<span class="lxform-field-warp lxform-email-wrap" data-name="'. $attr['name'] .'">';
            if($attr['label']) {
                $output .= '<label';
            ...
            $output .= ' class="lxform-field lxform-email '. $attr['class'] .'"';
