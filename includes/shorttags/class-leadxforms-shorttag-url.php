...
class LeadXForms_ShortCode_Url extends LeadXForms_ShortCode_Tag {
    ...
    public function output() {
        ...
        $output = '<span class="lxform-field-warp lxform-url-wrap" data-name="'. $attr['name'] .'">';
            if($attr['label']) {   
                $output .= '<label';
            ...
            $output .= ' class="lxform-field lxform-url '. $attr['class'] .'"';
