...
class LeadXForms_ShortCode_Appointment extends LeadXForms_ShortCode_Tag {
    ...
    public function output() {
        ...
        $output = '<span class="lxforms-field-warp lxforms-appointment-wrap" data-name="'. $attr['name'] .'">';
        if($attr['label']) {
            $output .= '<label';
