...
class LeadXForms_WpAjax_RecaptchaGetKeys {
    ...
    public function init() {
        $this->loader->add_action('wp_ajax_lxf_recaptcha_get_keys', $this, 'request');
        $this->loader->add_action('wp_ajax_nopriv_lxf_recaptcha_get_keys', $this, 'request');
    }
    ...
    public function request() {
        ...
        if($leadxforms_reCaptcha_keys) {
            $data = $leadxforms_reCaptcha_keys;
            $message = 'Success!';
        } else {
            $data = [];
            $message = 'Empty!';
