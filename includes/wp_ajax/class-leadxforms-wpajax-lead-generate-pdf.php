...
class LeadXForms_WpAjax_LeadGeneratePDF {
    ...
    public function init() {
        $this->loader->add_action('wp_ajax_lxf_lead_generate_pdf', $this, 'request');
        $this->loader->add_action('wp_ajax_nopriv_lxf_lead_generate_pdf', $this, 'request');
    }
