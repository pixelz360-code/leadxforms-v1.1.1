...
class LeadXForms_WpAjax_LeadGenerateExcel {
    ...
    public function init() {
        $this->loader->add_action('wp_ajax_lxf_lead_generate_excel', $this, 'request');
        $this->loader->add_action('wp_ajax_nopriv_lxf_lead_generate_excel', $this, 'request');
    }
