...
class LeadXForms_WpAjax_LeadDelete {
    ...
    public function init() {
        $this->loader->add_action('wp_ajax_lxf_lead_delete', $this, 'request');
        $this->loader->add_action('wp_ajax_nopriv_lxf_lead_delete', $this, 'request');
    }
    ...
    public function request() {
        ...
        $url = $this->loader->api_url() . '/lead/delete/'.$id;
