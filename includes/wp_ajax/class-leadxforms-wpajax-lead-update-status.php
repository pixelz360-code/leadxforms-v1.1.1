...
class LeadXForms_WpAjax_LeadUpdateStatus {
    ...
    public function init() {
        $this->loader->add_action('wp_ajax_lxf_lead_update_status', $this, 'request');
        $this->loader->add_action('wp_ajax_nopriv_lxf_lead_update_status', $this, 'request');
    }
    ...
    public function request() {
        ...
        $url = $this->loader->api_url() . '/lead/status/'.$id;
