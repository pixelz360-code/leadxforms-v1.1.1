...
class LeadXForms_WpAjax_LeadBulkDelete {
    ...
    public function init() {
        $this->loader->add_action('wp_ajax_lxf_lead_bulkdelete', $this, 'request');
        $this->loader->add_action('wp_ajax_nopriv_lxf_lead_bulkdelete', $this, 'request');
    }
    ...
    public function request() {
        ...
        $url = $this->loader->api_url() . '/lead/bulk_delete';
