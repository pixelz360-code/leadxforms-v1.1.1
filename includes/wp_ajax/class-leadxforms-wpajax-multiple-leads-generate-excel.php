...
class LeadXForms_WpAjax_MultipleLeadsGenerateExcel {
    ...
    public function init() {
        $this->loader->add_action('wp_ajax_lxf_multiple_leads_generate_excel', $this, 'request');
        $this->loader->add_action('wp_ajax_nopriv_lxf_multiple_leads_generate_excel', $this, 'request');
    }
    ...
    public function request() {
        ...
        $url = $this->loader->api_url() . '/lead/generate_excel';
